//! Taken from `nukkeldev/garden`, will probably be extracted into another library eventually.

const std = @import("std");

const FZ = @import("tracy.zig").FnZone;

const DEBUG = switch (@import("builtin").mode) {
...
pub const SDL = struct {
    ...
    pub const GPURenderPass = struct {
        ...
        pub fn begin(
            ...
            depth_stencil_target_info: [*c]c.SDL_GPUDepthStencilTargetInfo,
        ) !GPURenderPass {
